...
Recipes & ingredients; current order of operations (work in progress); where herbs.

**NOTE**: Order of Operations (OoOps) is just me trying to work out the best way for me to do it, and includes perks. If I haven't gotten around to it, it's just the recipe text.
...
- Weak: for 6 hours
  - Horsemanship, Houndmaster +3
  - "Animals will take less notice of you, so you'll find it easier to approach them"
...
- Strong: for 12 hours
  - Horsemanship, Houndmaster +5
  - "Animals will take less notice of you, so you'll find it easier to approach them"

- Henry: for 24 hours
  - Horsemanship, Houndmaster +7
  - "Animals will take less notice of you, so you'll find it easier to approach them"

#### Aesop OoOps

Prep: Spiritus, 1x Belladonna, 1x Boar's Tusk, 2x Comfrey

1) Spirits & lower cauldron
2) 2x Comfrey -> mortar
3) Grind Comfrey
4) Comfrey -> bowl
5) Comfrey -> cauldron
6) 1x Boar Tusk -> cauldron
7) 1x Belladonna -> mortar
8) Grind Belladonna
9) Belladonna -> cauldron
10) Lift cauldron
11) 1x Vial
12) Distill
...
Prep: Water, 2x Dandelion, 1x Marigold

1) Water
2) 1x Marigold -> mortar
3) 1x Dandelion -> cauldron
4) Lower cauldron
5) Grind marigold
6) Marigold -> cauldron
7) Timer (wait 1 Turn)
...
- Strong: for 10 minutes
  - Strength +4
  - Attack and Defence cost 25% less stamina

- Henry: for 15 minutes
  - Strength +6
  - Attack and Defence cost 35% less stamina

#### Artemsia OoOps

Prep: Spirits, 2x Wormwood, 1x Sage

1) Spirits
2) 2x Wormwood -> mortar
3) 1x Sage -> cauldron
4) Lower cauldron
5) Grind wormwood
6) Wormwood -> cauldron
...
Prep: Wine, 1x Wormwood, 2x Belladonna, 1x Amanita Muscaria

1) Wine
2) 1x Wormwood -> cauldron
3) Lower cauldron
4) 2x Belladonna -> mortar
5) Grind Belladonna
6) Belladonna -> cauldron
7) Bellows (1)
8) Lift cauldron
9) Amanita -> cauldron
10) Vial, distill
...
- Normal: for 10 minutes
  - Marksmanship +3
  - Reduce stamina loss when aiming by 20%

- Strong: for 10 minutes
  - Marksmanship +5
  - Reduce stamina loss when aiming by 50%

- Henry: for 15 minutes
  - Marksmanship +8
  - No stamina loss when aiming

#### Bowman's Brew OoOps

Prep: Spirits, 2x Eyebright, 1x St. John's Wort

1) Spirits
2) 2x Eyebright -> cauldron
3) Lower cauldron
4) 1x St John's -> mortar
5) Grind St John's
6) St John's -> dish
7) Timer (wait 1 Turn)
8) St John's -> cauldron
9) Bellows (1)
...
- Weak: for 20 minutes
  - Increase stamina by 25%

- Normal: for 20 minutes
  - Increase stamina by 30%

- Strong: for 40 minutes
  - Increase stamina by 30%
  - Increase stamina regeneration by 15%

- Henry: for 1 hour
  - Increase stamina by 60%
  - Increase stamina regeneration by 30%

#### Buck's Blood OoOps

Prep: Oil, 1x St. John's wort, 1x Dandelion, 1x Comfrey

1) Oil
2) 1x St John's -> Mortar
3) Grind St John's
4) St John's -> cauldron
5) 1x Comfrey -> cauldron
6) Lower cauldron
7) Hourglass
8) 1x Dandelion -> hand
9) 1x turn, Dandelion -> cauldron
10) Hourglass
11) Bellows
12) Phial -> hand
13) 1x Turn -> pour
...
- Weak: for 12 hours
  - Sleep heals 2x faster

- Normal: for 24 hours
  - Sleep heals 3x faster

- Strong: for 24 hours
  - Sleep heals 4x faster
  - Sleep restores energy 2x faster

- Henry: for 48 hours
  - Sleep heals 5x faster
  - Sleep restores energy 3x faster

#### Chamomile OoOps

Prep: Wine, Chamomile x2, Sage x1

1) Wine
2) 1x Sage -> Mortar
3) 2x Chamomile -> cauldron
4) Lower cauldron
5) Grind sage
6) Sage -> bowl
7) Lift cauldron
...
- Strong:
  - +20 energy (instant)
  - Energy decreases 20% slower (12 hours)

- Henry:
  - +30 energy (instant)
  - Energy decreases 50% slower (24 hours)

#### Cockerel OoOps

Prep: Spirits, 1x Valerian, 2x Mint
...
- Weak:
  - Cures food poisoning (instant)
  - -20 Nourishment (instant)

- Normal:
  - Cures poisoning (instant)
  - -20 Nourishment (instant)
...
- Strong:
  - Cures poisoning (instant)
  - -20 Nourishment (instant)
  - +2 Vitality (10 minutes)

- Henry:
  - Cures poisoning (instant)
  - -30 Nourishment (instant)
  - +3 Vitality (20 minutes)
...
- Normal:
  - -3 to all weapon skills (instant)
  - Running = Impossible (instant)
  - -20 Health (over time)

- Strong:
  - -4 to all weapon skills (instant)
  - Running = Impossible (instant)
  - -30 Health (over time)

- Henry:
  - -5 to all weapon skills (instant)
  - Running = Impossible (instant)
  - -50 Health (over time)

#### Dollmaker OoOps

Prep: Spirits, 1x Valerian, 2x Herb Paris

1) Spirits
2) 2x Herb Paris -> cauldron
3) Lower cauldron
4) Timer (1.5 turns)
5) 1x Valerian -> mortar
6) Valerian -> cauldron
7) Timer (wait 1 turn)
8) Vial -> hand (leisurely)
9) Distill
...
- Normal: for 10 minutes
  - +4 agility
  - Sprint cost 10% less stamina

- Strong: for 15 minutes
  - +4 agility
  - Sprint cost 20% less stamina

- Henry: for 20 minutes
  - +6 agility
  - Sprint cost 30% less stamina

#### Embrocation OoOps

Prep: Oil, 1x Eyebright, 1x Poppy, 1x Valerian, 1x Boar's Tusk

1) Oil
2) 1x Poppy -> cauldron
3) 1x Valerian -> cauldron
4) Lower cauldron
5) 1x Eyebright -> mortar
6) Grind Eyebright
7) Eyebright -> cauldron
8) Boar's Tusk -> cauldron
...
> "Fever and related complications can often lead to death. This tonicum will alleviate fever if given in time."

#### Fever Tonic OoOps

Prep: Wine, 3x Feverfew, 2x Ginger, 1x Elderberry Leaves

Add Wine to the cauldron.
Add the Feverfew and boil for 2 turns.
...
Prep: Oil, 1x Nettle, 1x St. John's Wort, 1x Belladonna, 1x Charcoal

1) Oil
2) 1x Nettle -> Mortar
3) 1x St John's -> Mortar
4) Grind Nettle & St John's
5) Nettle & St John's -> cauldron
6) Lower cauldron
7) Charcoal -> mortar
8) Grind Charcoal
9) Charcoal -> cauldron
10) Belladonna -> cauldron
...
- Henry:
  - eliminates drunkeness
  - eliminates hangover
  - supresses effects of alcoholism

#### Hair O' The Dog OoOps
...
> "Drink one mouthful and you'll forget all earthly experience. Obliterates all perk points, so they can be used elsewhere."
...
> "if you use it in combination with another perfume, it decreases Charisma by 7"

- Weak: for 3 minutes
  - +3 charisma

- Normal: for 4 minutes
  - +4 charisma

- Strong: for 5 minutes
  - +7 charisma

- Henry: for 10 minutes
  - +10 charisma
...
- Weak:
  - +15 health (over 1 minute)
  - Hangovers pass 50% faster (for 1 minute)

- Normal:
  - +25 health (over 1 minute)
  - Hangovers pass 50% faster (for 1 minute)

- Strong:
  - +40 health (over 1 minute)
  - Cures handover (instant)

- Henry:
  - +60 health (over 1 minute)
  - Cures hangover (instant)

#### Marigold OoOps

Prep: Water, 1x Nettle, 2x Marigold

1) Water
2) 1x Nettle -> cauldron
3) Lower cauldron
4) 2x Marigold -> mortar
5) Grind Marigold
6) Marigold -> cauldron
7) Lift cauldron
8) Vial, pour
...
> "if you use it in combination with another perfume, it decreases Charisma by 5"
...
> "Strong alcoholic drink. Watch out for the hangover!"
...
- Normal: for 15 minutes
  - Energy decreases 25% slower
  - "You will see better in the dark"

- Strong: for 20 minutes
  - Energy decreases 50% slower
  - "You will see better in the dark"

- Henry: for 25 minutes
  - Energy will not decrease at all
  - "You will see better in the dark"
...
- Weak: for 10 minutes
  - "Supresses the effects of injury"
  - Maximum stamina decreases with health 15% less [what the fuck does this mean]

- Normal: for 15 minutes
  - "Supresses the effects of injury"
  - Maximum stamina decreases with health 30% less

- Strong: for 20 minutes
  - "Supresses the effects of injury"
  - Maximum stamina decreases with health 50% less

- Henry: for **15** minutes
  - "Supresses the effects of injury"
  - Maximum stamina decreases with health 75% less
...
- Normal:
  - saves the game
  - +10 health
  - +1 Strength, Vitality, Agility (3 minutes)
  
- Strong:
  - saves the game
  - +200 health
  - +2 Strength, Vitality, Agility (5 minutes)

- Henry:
  - saves the game
  - +30 health
  - +3 Strength, Vitality, Agility (8 minutes)

#### Saviour Schnapps OoOps

Prep: Wine, 1x Nettle, 2x Belladonna

1) Wine
2) 1x Nettle -> cauldron
3) Lower cauldron
4) 2 x Belladonna -> mortar
5) Belladonna -> cauldron
...
> "Soap, a mix of fat, ash, and who knows what else. Combined with water, it works miracles on dirty clothes."
...
> "A lead ball. It rattles a little in the barrel, but at least it's easy to load. Even the best plate armour can't stop it up close!"
...
> "A pile of scrap iron and rocks tied up in a small bag. It'll shred anyone at close range, but at a distance it's rather useless."
...
| :----- | ---: | -----: | -----: | ------: |
| Aesop | 35 | 45 | 55 | 70 |
| Aqua Vitalis | 35 | 45 | 55 | 70 |
| Artemisia | 35 | 45 | 55 | 70 |
| Bane | 30 | 40 | 50 | 70 |
| Bowman's Brew | 35 | 45 | 55 | 70 |
| Buck's Blood | 35 | 45 | 55 | 70 |
| Chamomile Brew | 20 | 25 | 35 | 50 |
| Cockerel | 35 | 45 | 55 | 70 |
| Digestive Potion | 20 | 25 | 35 | 50 |
| Dollmaker | 25 | 35 | 45 | 60 |
| Embrocation | 35 | 45 | 55 | 70 |
| Fever Tonic | - | 40 | - | - |
| Fox | 35 | 45 | 55 | 70 |
| Hair O' The Dog | 35 | 45 | 55 | 70 |
| Lethean Water | - | 90 | - | - |
| Lion | 50 | 60 | 70 | 90 |
| Lullaby | 25 | 35 | 45 | 60 |
| Marigold Decoction | 30 | 40 | 50 | 60 |
| Mintha | 30 | 35 | 45 | 60 |
| Moonshine | - | - | - | - |
| Nighthawk | 35 | 45 | 55 | 70 |
| Painkiller Brew | 35 | 45 | 55 | 70 |
| Quickfinger | 35 | 45 | 55 | 70 |
| Saviour Schnapps | 25 | 30 | 40 | 55 |
| Soap | - | 20 | - | - |
| Lead Shot Gunpowder | - | - | - | - |
| Scattershot Powder | - | - | - | - |
